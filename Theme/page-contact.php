...
//response messages
$not_human       = "Answer is between one and three";
$missing_content = "Please fill all fields.";
$email_invalid   = "Please check your eMail.";
$no_consent      = "GDPR - You have to agree with storing your details.";
...
<div class="container">
  ...
  <div class="contact-form">
    <div class="contact-header">
      <h1>Contact form</h1>
      <p>Do not hesitate to contact us. Before sending your message double check your eMail.<br>We will not be able to deliver our reply if address is wrong.</p>
    </div>
    <?php echo $response; ?>
    <form action="<?php the_permalink(); ?>" method="post">
      <input type="text" name="message_name" placeholder="Your Name" value="<?php echo esc_attr($_POST['message_name']); ?>"><br>
      <input type="text" name="message_email" placeholder="Your eMail" value="<?php echo esc_attr($_POST['message_email']); ?>"><br>
      <textarea type="text" name="message_text" placeholder="Message"><?php echo esc_textarea($_POST['message_text']); ?></textarea><br>
      <p><label for="message_human">I am not a robot:<br>5 - 3 = <input type="text" style="width: 60px;" name="message_human"></label></p><br>
